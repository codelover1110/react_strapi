...
const OverView = () => {
    ...
    const [ overViewType, setOverViewType ] = useState('client');
        ...
        <Box className={classes.root}>
            <Paper>
                ...
                <Box className={classes.tab}>
                    <Grid container>
                        <Grid item xs={6} className={classes.tabToggle} sx={{boxShadow: (overViewType === 'client') ? '0px 4px 8px -2px rgba(0, 0, 0, 0.25), inset 0px -1px 1px rgba(0, 0, 0, 0.04), inset 0px 2px 0px rgba(255, 255, 255, 0.25)' : 'none', background: overViewType === 'client' ? theme.palette.common.white : '' }} onClick={() => {setOverViewType('client')}}>
                            <Grid container>
                        ...
                        <Grid item xs={6} className={classes.tabToggle} sx={{boxShadow: (overViewType === 'customer') ? '8px 8px 8px -2px rgba(0, 0, 0, 0.25), inset 0px -1px 1px rgba(0, 0, 0, 0.04), inset 0px 2px 0px rgba(255, 255, 255, 0.25)' : 'none', background: overViewType === 'customer' ? theme.palette.common.white : ''}} onClick={() => {setOverViewType('customer')}}>
                            <Grid container>
                                <Grid item xs={match1 ? 9 : 12} sx={{display : 'flex'}}>
                                    {
                                        match2 &&
